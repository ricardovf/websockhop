...
function isInvalidSafari() {
  return browser.safari && !browser.chrome && parseFloat(browser.version) < 534.54;
}
...
exports.isWebSocketUnavailable = isWebSocketUnavailable;
exports.isInvalidSafari = isInvalidSafari;
